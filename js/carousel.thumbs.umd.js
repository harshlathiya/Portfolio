!(function (t, e) {
  ...
  class d extends h {
        ...
        for (const i of this.instance.slides || []) {
          ...
          (i.type &&
            ...
            i.type &&
              ...
              (s += " for-video")),
            t.push({ html: this.formatThumb(i, e), customClass: s }));
        }
      return t;
    }
    onInitSlide(t, e) {
    ...
    onClickModern(t) {
      ...
      let o = s(t.target);
      (o < 0 &&
        ((o = n(t.clientX + this.thumbGap, t.clientY)), o === i && (o = i - 1)),
        o < 0 &&
          ((o = n(t.clientX - this.thumbGap, t.clientY)),
          o === i && (o = i + 1)),
        o < 0 &&
          (o = ((e) => {
    ...
    onTransformM() {
      ...
      for (const e of t.slides) {
        let i = e.index,
          s = e.thumbSlideEl;
        if (!s) continue;
        (o(s, this.cn("isSelected"), i === t.page),
          (c = 1 - Math.abs(t.getProgress(i))),
          s.style.setProperty("--progress", c ? c + "" : ""));
        const l = 0.5 * ((e.thumbWidth || 0) - a);
        ((h += n),
          (h += l),
          c && (h -= c * (l + r)),
          s.style.setProperty("--shift", h - n + ""),
          (h += l),
          c && (h -= c * (l + r)),
          (h -= n),
          0 === i && (u = r * c));
      ...
      (i &&
        (i.style.setProperty("--left", u + ""),
        i.style.setProperty("--width", h + u + n + r * c + "")),
    ...
    buildClassic() {
      ...
      const n = new this.instance.constructor(
        ...
        e(
          ...
          { Sync: { target: this.instance }, slides: s },
        ),
      );
      ((this.carousel = n),
        (this.track = i),
    ...
    buildModern() {
      if ("modern" !== this.type) return;
      const { container: t, track: e, instance: s } = this,
      ...
      for (const t of s.slides || []) {
        ...
        (s.appendChild(i(this.formatThumb(t, o))),
          (t.thumbSlideEl = s),
          e.appendChild(s),
        ...
        bounds: () => {
          ...
          return (
            i &&
              ...
              0 !== s.page && (e += 0.5 * (i.thumbWidth || 0)),
              (t = -1 * this.getModernThumbPos(s.slides.length - 1)),
              s.page !== s.slides.length - 1 &&
                (t +=
                  (n.thumbWidth || 0) -
                  (o.thumbWidth || 0) -
                  0.5 * (n.thumbWidth || 0))),
      ...
      (r.on("touchStart", (t, e) => {
        ...
        r.on("click", (t, e) => this.onClickModern(e)),
        r.on("ready", () => {
      ...
      if (e.state !== l.Init || 0 === o)
        for (const o of t.slides || []) {
          ...
          const r = t.querySelector("img[data-lazy-src]"),
            ...
            l = s - 0.5 * e.containerRect.innerWidth,
    ...
    getModernThumbPos(t) {
      ...
      2 === this.instance.slides.length &&
        ((t -= 1), (n = 2 * this.thumbClipWidth));
      let o =
        t * (this.thumbClipWidth + this.thumbGap) +
        this.thumbExtraGap +
        0.5 * (e.thumbWidth || 0);
      return ((o -= n > s ? 0.5 * s : 0.5 * n), c(o || 0, 1));
    }
    build() {
      const e = this.instance,
        i = e.container,
      ...
      if (s) {
        ...
        if (i < s)
          return (this.cleanup(), void (this.state = t.States.Disabled));
      }
      const o = this.option("type");
      if (["modern", "classic"].indexOf(o) < 0)
        return void (this.state = t.States.Disabled);
      this.type = o;
      const r = document.createElement("div");
      (n(r, this.cn("container")), n(r, `is-${o}`));
      const a = this.option("parentEl");
      (a ? a.appendChild(r) : i.after(r),
        (this.container = r),
        n(i, this.cn("hasThumbs")));
          ...
          setTimeout(() => {
            ...
            null ===
              (t =
                null == r
                  ? void 0
                  : r.querySelector(`[data-carousel-index="${e.page}"]`)) ||
              void 0 === t ||
              t.focus();
          }, 100);
        }));
