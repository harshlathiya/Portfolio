!(function (t, e) {
  ...
  class w extends v {
    ...
    static startFromUrl() {
      if (
        ((w.hasSilentClose = !1), It.getInstance() || !1 === It.defaults.Hash)
      )
        return;
  ...
  class A {
    ...
    onTouchStart(t) {
      for (const e of Array.from(t.changedTouches || []))
        this.triggerPointerStart(new T(e), t);
      window.addEventListener("blur", this.onWindowBlur);
    }
    onMove(t) {
      const e = this.currentPointers.slice(),
        i =
          "changedTouches" in t
            ? Array.from(t.changedTouches || []).map((t) => new T(t))
            : [new T(t)],
        n = [];
      for (const t of i) {
    ...
    onTouchEnd(t) {
      for (const e of Array.from(t.changedTouches || []))
        this.triggerPointerEnd(t, new T(e));
    }
  ...
  class Y extends b {
    get isTouchDevice() {
      return (
        null === X && (X = window.matchMedia("(hover: none)").matches),
        X
      );
    }
    get isMobile() {
    ...
    constructor(t, e = {}, i = {}) {
      ...
      ((this.container = t),
        this.initContent(),
        this.attachPlugins(Object.assign(Object.assign({}, Y.Plugins), i)),
        this.emit("init"));
    ...
    onPointerDown(t, e, i) {
      ...
      return (
        ...
        E(this.targetScale, 1e3) === E(this.minScale, 1e3)
          ? (this.stop(),
    ...
    startDecelAnim() {
      ...
      (Math.abs(u) < f && Math.abs(p) < f && ((a = r = 0), (l = c = 0)),
    ...
    updateMetrics(t = !1) {
      ...
      const { container: e, containerRect: i, content: n } = this,
        ...
        u = parseFloat(l.paddingLeft) + parseFloat(l.paddingRight);
      this.containerRect = {
        width: c,
        height: h,
        innerWidth: c - u,
      ...
      (m.style.setProperty("transform", "none", "important"),
        s && ((m.style.width = ""), (m.style.height = "")),
        m.offsetHeight);
      ...
      if (
        (s &&
          ...
          })(b.width, b.height, p, f)),
        (this.contentRect = Object.assign(Object.assign({}, this.contentRect), {
          top: b.top - r.top + w,
          bottom: r.bottom - b.bottom + w,
          left: b.left - r.left + x,
          right: r.right - b.right + x,
          fitWidth: v,
          fitHeight: y,
          width: v,
          height: y,
        ...
        (m.style.cssText = g),
        s && ((m.style.width = `${v}px`), (m.style.height = `${y}px`)),
        this.setTransform(),
        !0 !== t)
      ) {
        let t = "";
    ...
    zoomWithWheel(t) {
      ...
      (E(r) < E(a) && E(s) <= E(a)
        ...
        this.cwd > this.option("wheelLimit") ||
          (t.preventDefault(), E(r) !== E(s) && this.zoomTo(r, { event: t })));
    }
    canZoomIn() {
      return (
        this.option("zoom") &&
        ...
        t.panzoom = new Y(
          ...
          i({}, this.option("Panzoom") || {}, {
            ...
            click: (e, i) => {
              ...
              if (
                t.index !==
                (null === (n = c.getSlide()) || void 0 === n ? void 0 : n.index)
              )
                return !1;
              let o =
                !i ||
            ...
            dblClick: () =>
              c.isCompact ? "toggleZoom" : c.option("contentDblClick") || !1,
            spinner: !1,
            panOnlyZoomed: !0,
            wheelLimit: 1 / 0,
            transformParent: !0,
    ...
    onTransformM() {
      ...
      for (const e of t.slides) {
        let i = e.index,
          n = e.thumbSlideEl;
        if (!n) continue;
        (M(n, this.cn("isSelected"), i === t.page),
          (l = 1 - Math.abs(t.getProgress(i))),
          n.style.setProperty("--progress", l ? l + "" : ""));
        const h = 0.5 * ((e.thumbWidth || 0) - a);
        ((r += s),
          (r += h),
          l && (r -= l * (h + o)),
          n.style.setProperty("--shift", r - s + ""),
          (r += h),
          l && (r -= l * (h + o)),
          (r -= s),
          0 === i && (c = o * l));
  ...
  class ct extends v {
    ...
    onClick(t) {
      ...
      if (void 0 !== l.fancyboxToggleSlideshow) {
        ...
        let s = e.isActive;
        return (
          a && "mousemove" === a.panMode && !s && a.reset(),
  ...
  class Et extends b {
    ...
    createPages() {
      ...
      if ("number" == typeof n && e > i) {
        for (let e = 0; e < this.slides.length; e += n)
          t.push(gt({ index: e, slides: this.slides.slice(e, e + n) }));
        return t;
      }
      let s = 0,
        o = 0;
    ...
    repositionSlides() {
      ...
      if (this.isInfinite && r)
        for (const i of this.slides)
          i.el &&
            (E(i.pos) < E(t) &&
              E(i.pos + i.dim + i.gap) < E(l) &&
              E(l) > E(e - t) &&
              (i.el.style[s] = `${E(a + r, 1e3)}px`),
            E(i.pos + i.gap) >= E(e - t) &&
              E(i.pos) > E(l + t) &&
              E(l) < E(t) &&
              (i.el.style[s] = `-${E(r, 1e3)}px`));
      let c,
        h,
        d = [...this.inTransition];
      if (
        ...
        for (const e of this.slides)
          e.el
            ? this.inTransition.has(e.index) &&
              ...
              (e.el.style[s] = `${E(t + (c.pos - h.pos), 1e3)}px`)
            : (t += e.dim + e.gap);
      }
    }
    createSlideEl(t) {
          ...
          i.el &&
            ...
            this.pages[this.page].slides.includes(i)
              ? (i.el.classList.contains(e) ||
                  (F(i.el, e), this.emit("selectSlide", i)),
                i.el.removeAttribute(t))
              : (i.el.classList.contains(e) &&
                  (D(i.el, e), this.emit("unselectSlide", i)),
    ...
    updateMetrics() {
      ...
      this.viewport &&
        (this.viewportDim = E(this.viewport.getBoundingClientRect()[e], 1e3));
  ...
  class It extends b {
      ...
      ((this.state = p.Init),
        ...
        !0 === this.option("hideScrollbar") &&
          (() => {
            ...
            (document.documentElement.style.setProperty(Ct, `${e}px`),
              n && t.style.setProperty(Mt, `${n}px`),
              t.classList.add(Pt));
          })(),
        this.initLayout());
      const t = () => {
      ...
      (t
        ? (!n || h.indexOf(n) < 0) &&
          ...
          h.length &&
            (i === Lt
              ? (u = h[0])
              : (this.lastFocus !== s && i !== zt) || (u = h[h.length - 1])))
    ...
    isTopmost() {
      var t;
      return (
        (null === (t = It.getInstance()) || void 0 === t ? void 0 : t.id) ==
        this.id
      );
    }
    animate(t = null, e = "", i) {
    ...
    static unbind(t, e) {
      ...
      (s && n && s.delete(n),
        (n && s) ||
          (It.openers.delete(i), i.removeEventListener("click", It.fromEvent)));
    }
    static destroy() {
      let t;
      for (; (t = It.getInstance()); ) t.destroy();
      for (const t of It.openers.keys())
        t.removeEventListener("click", It.fromEvent);
      It.openers = new Map();
    }
    static fromEvent(t) {
      if (t.defaultPrevented) return;
      ...
      if (
        ...
        e &&
          !h &&
          (l = p ? l.filter((t) => t.getAttribute(`${d}`) === p) : [e]),
        !l.length)
      )
        return;
